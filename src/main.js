...
function init() {
  ...
  const container = document.getElementById('appElement');

  camera = new THREE.PerspectiveCamera(30, window.innerWidth / window.innerHeight, 1, 5000);
  camera.position.set(0, 60, 1200);
  ...
  loader.load('model6.gltf', function (gltf) {
    ...
    // mixer.clipAction(gltf.animations[0]).setDuration(1).setLoop(THREE.LoopRepeat).play();
    // mixers.push(mixer);
  ...
  // 加载背景图片
  let texture = textureLoader.load('bg5.png');
